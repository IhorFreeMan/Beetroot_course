...
import sys
print(sys.path.append(os.path.join(BASE_DIR, 'sam_moduls')))
...
be passed-in, hard-coded, input with raw_input, or pulled from a command-line via the sys.argv list; 
...
from sam_moduls import mymod

name = "sam_moduls/sam_wors.txt"
